export const voies = [
  ...
  },
  {
    ...
    name: "Voie du Catalyseur d'Ether",
    description:
      "Cette voie se concentre sur la manipulation de l'éther environnant, permettant à l'Arcaniste de renforcer ses alliés ou d'infliger des attaques précises et puissantes.",
  },
  {
  ...
  {
    slug: 'chimiste-toxique',
    name: 'Voie du Chimiste Toxique',
    description:
  ...
  },
  {
    ...
    name: 'Voie du Géomancien Elémentaire',
    description:
      "L'Arcaniste canalise les éléments naturels pour des attaques directes dévastatrices et des effet de renforcement.",
  },
  {
    slug: 'graveur-de-runes',
    name: 'Voie du Graveur de Runes',
    description:
      "L'Arcaniste maîtrise l'art des runes magiques, gravant dans l'air ou sur le sol des symboles qui libèrent une puissance destructrice ou confèrent des effets bénéfiques à lui-même ou à ses alliés.",
  },
  {
    slug: 'inventeur-chimiste',
    name: "Voie de l'Inventeur Chimiste",
    description:
  ...
  },
  {
    ...
    name: 'Voie du Transmutateur Visionnaire',
    description:
      'Manipulation alchimique avancée pour transformer des matériaux ou des éléments.',
  },
];
